...
public class Menu {
    ...
    public void addNewRegister(Scanner scanner) {
        ...
        AddressEntry newRegister = new AddressEntry(firstName, lastName, street, city, state, zip, phoneNumber, emailAddress);
    ...
    public void removeRegister(Scanner scanner) {
        if (addressBook.getAllRegisters().isEmpty()) {
            System.out.println("Lista vacía, no hay nada que eliminar");
            return;
        }
    ...
    public void searchRegister(Scanner scanner) {
        if (addressBook.getAllRegisters().isEmpty()) {
            System.out.println("Lista vacía, no hay nada que buscar");
            return;
        }
    ...
    public void showAllRegisters() {
        if (addressBook.getAllRegisters().isEmpty()) {
            System.out.println("Lista vacía, no hay nada que mostrar");
            return;
        }
